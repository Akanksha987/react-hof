...
// Progression 2 // display all list items
renderItems = () => {
...
//   progression 4// list of data on the basis of letter "J"
...
//   progression 5// list of data on the basis of age
  renderBasedOnAge = () => {
    const data = this.state.userData;
    const filterData = data.filter((item)=>{
...
//   progression 6 // list of data on the basis of total age of designers
